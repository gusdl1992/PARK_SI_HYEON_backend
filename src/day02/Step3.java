...
public class Step3 {    // c s
    ...
    public static void main(String[] args) { // m s
        ...
        // [ p.70 ] 콘솔에서 키보드로부터 입력 받고 변수에 저장
            // [ 준비물 ]
            // 풍부한 라이브러리 지원 ( 여러개 함수 지원 /골라 쓸수 있다. )
        ...
        // [ Scanner 제공하는 메소드 ]
        // 1. 입력받은 문자열(String) 반환. 뛰어쓰기 포함 불가
        String str1 = scanner.next();
        System.out.println("str1 = " + str1);

        scanner.nextLine(); // 의미없는 nextLine() 추가하기.
        // 2. 입력받은 문자열(String) 반환 뛰어쓰기 포함 [ 주의할점 : 앞에 next() 있을경우 하나로 취급 ]
        String str2 = scanner.nextLine();   
        System.out.println("str2 = " + str2);
        
        // 3. 입력받은 데이터를 논리(Boolean) 반환
