...
public class Level1_6 {
	...
	public static void main(String[] args) {
		...
		byte var1 = (byte)value1;
		short var2 = (short)value2;
		int var3 = (int)value3;
		long var4 = (long)value4;
		float var5 = (float)value5;

		System.out.printf("byte <- short : %d \n" , var1);
		System.out.printf("short <- int : %d \n" , var2);
		System.out.printf("int <- long : %d \n" , var3);
		System.out.printf("long <- float : %d \n" , var4);
		System.out.printf("float <- double : %8.7f \n" , var5);
