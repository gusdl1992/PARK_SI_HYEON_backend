...
public class Step1 {
    public static void main(String[] args) {
        ...
        String hobby = "여행";
            ...
            // "여행" : 힙영역에 생성된 문자열 개게 [ 102번지 ]
                // = 대입  102번지를 hobby 변수에 대입
                // !! : hobby 변수에는 "여행"문자열을 가지고 있지 않다.
        hobby = null;
            // hobby 변수가 null을 가짐
            // "여행" 객체는 현재 아무도 참조 하지 않기 때문에 잠시후 자동으로 힙영역 에서 삭제된다.
        String kind1 = "자동차";
    ...
    /*
        ...
        5. 배열의 구조
            1. 스택은 배열의 0번 인덱스 주소를 참조한다. [ 어차피 나열했기때문에 순서대로 메모리 할당 ]
                - 인덱스 마다 주소값.
                - { "유재석" , "강호동"}; : 102번지 103번지
            ...
            String[] array2                       1. 배열객체 = { null , null}      201 번지
                                                  2. 배열객체 = { 204번지 , null }   201 번지
            1. 배열내 특정 항목 대입
            array2[0] = "유재석"
                                                  1. 문자열(유재석)객체 = 204 번지
     */
        ...
        // 2.
        System.out.println("array2 = " + array2);   // array2 = [Ljava.lang.String;@6d311334 => 배열의 주소는 대입되지만 배열안에 값이 null
        System.out.println("array2[1] = " + array2[1]); // array2[1] = null
        // 3.
        array2[0] = "유재석";

    } // m e

    // 함수종료 => 지역변스들 => 지역변수 사라짐 => 지역변수가 참조한 힙영역 사라짐
