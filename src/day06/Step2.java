...
public class Step2 {
    public static void main(String[] args) {
        ...
        System.out.println(name2.equals(name3) ); // 같다. [ 스택이 가지는 주소/참조의 내부를 비교 ]

            // 4.
        Scanner scanner = new Scanner(System.in);
        String inputName =  scanner.next(); // 새로운 문장열 반환.
        ...
        String hobby2 = "";
        if (hobby2.equals("")){
            System.out.println("hooby변수가 참조하는  String 객체는 빈 문자열");
        }
